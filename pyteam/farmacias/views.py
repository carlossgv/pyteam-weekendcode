...
def encuentra_farmacias_cercanas(request, direccion):
    ...
    farmacias_cercanas = devuelve_farmacias_cercanas(
        usuario_latitud, usuario_longitud, URL
    )
    ...
    if farmacias_cercanas:
        ...
        return JsonResponse(
            [{"local_id": "-1"}], safe=False
        )  # En caso de no haber farmacias cercanas devuelve esto
